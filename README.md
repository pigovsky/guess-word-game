...
#Правила гри
1. Користувач отримує бонусних 100 балів, коли перший раз заходить в гру.
2. Користувач за кожне правильно вгадане слово отримує 20 балів.
3. За кожне невірне слово з користувача знімається 10 балів.
4. Користувач може вгадувати слово по буквам.
5. За кожну невірну букву з користувача знімається 1 бал.
6. В користувача є підказки: 
1) Показує половину слова(вартість 50 балів).
2) Показує першу і останню букву слова(вартість 30 балів).
