...
## Перше завдання(Правила гри)
Правила:
1. Якщо користувач ввів правильну відповідь, йому нараховуються бали, кількість яких залежить від довжини слова.
2. Якщо відповідь неправильна, виводиться відповідне повідомлення, бали не нараховується та переходить до наступного питання.
