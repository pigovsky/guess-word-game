...
namespace GuessWordGame
{
    public interface IInformationForm
    {
        ...
        void Showw(User user);
        void Hidee();
        int id { get; set; }
    }
    public partial class InformationForm : MetroForm, IInformationForm
    {
        ...
        public string Password
        {
            get
            {
                ...
                {
                    throw new Exception("Введіть ваш пароль");
                }
            }
        }
        ...
        public void Showw(User user)
        {
            ...
            tbDay.Text = user.dateOfBirth.Day.ToString();
            tbMonth.Text = user.dateOfBirth.Month.ToString();
            tbYear.Text = user.dateOfBirth.Year.ToString();
            id = user.id;
