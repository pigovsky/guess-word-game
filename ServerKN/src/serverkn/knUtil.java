...
final class ByteChars {
	...
	public void write(char[] chs, int len){
		if((cnt + len) >= max)
			realloc(len);
...
final class kv_parser {
	public final static int  MAX_SIZE  = 524288; //1-MB
	public final static char CH_BEGIN  = '{';
	public final static char CH_END    = '}';
	public final static char CH_STRING = '"';
	public final static char CH_DELIM  = ':';
